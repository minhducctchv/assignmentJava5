        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="${pageContext.request.contextPath }/admin/tai-khoan/insert" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm mới tài khoản</span></a>					
					</div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
					<c:forEach var="taikhoan" items="${taikhoans }">
						<%@ include file="/common/forloop/td_qltk.jsp" %>
					</c:forEach>                    
                </tbody>
            </table>
        </div>
	...
	<div id="searchModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">Tìm môn học</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<div class="form-group">
